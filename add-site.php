								...
								<table class="table table-striped display" style="white-space:nowrap;width:95%; line-height: 0%; margin-top: auto; margin-bottom: auto;text-align:center; vertical-align: auto;" align="center">		
									<tbody>
										...
										<tr>
											...
											<td><div class="form-group"></div></td>	
											<td style="text-align:center; vertical-align: middle;"><div class="form-group"><label>33KV Grid Name</label><input type="text" name="kvaGridNamethtw" style="text-transform: capitalize" placeholder="Name of Grid Sub-Station" value="" required="" class="form-control"></div></td>
											<td><div class="form-group"></div></td>	
								...
								<table id="datable_rptA" class="datatable-1 display table table-fit table-bordered table-striped wrap cell-border compact stripe" style="width:100%;">	
									<thead>
										<tr><!-- Table Row & head-->
											...
											<th style="font-size:11px;text-align:center; vertical-align: middle;height:auto;">32KVA Grid Name</th>
											<th style="font-size:11px;text-align:center; vertical-align: middle;height:auto;">11KVA Grid Name</th>
...
<?php 
$uid=$_SESSION['warroomuid'];
$query=mysqli_query($con,"select si.id,si.genericid,si.siteCode,si.genSite,si.hubSite,si.shareType,si.Priority,si.inHouseFlm,si.postingDate,si.siteType,si.powerStatus,si.District,si.Thana,si.ConnectedSites,si.kvaGridNamethtw,si.kvaGridNameoo,si.updationDate,si.remarks from siteinfo as si LEFT JOIN tbluser usr ON si.officeid=usr.officeid where usr.id='$uid'");
$cnt=1;
...
?>								
										<tr>
											 ...
											 <td style="font-size:11px;text-align:center; vertical-align: middle;" ><?php echo htmlentities($row['kvaGridNamethtw']);?></td>
											 <td style="font-size:11px;text-align:center; vertical-align: middle;" ><?php echo htmlentities($row['kvaGridNameoo']);?></td>
											
											<td style="text-align:center">
											<a href="updatesite.php?sid=<?php echo $row['id']?>" ><i class="icon-edit" style="color:orange"></i></a>
											<a href="add-site.php?sid=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete this Site?')"><i class="icon-remove-sign" style="color:red"></i></a>
											</font></td>
